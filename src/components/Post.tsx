...
export default function Post({ post }: PostProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-3 md:p-4 border border-secondary">
      <div className="flex items-start space-x-2 md:space-x-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="mt-1 text-text break-words">{post.content}</p>
          <div className="mt-3 flex items-center space-x-6 md:space-x-8 text-gray-500 text-sm">
